...
export const WrapperAuth: FC<WrapperAuthProps> = ({children}) => {
	return (
		<section className="w-full flex" style={{height: '100vh'}}>
			<div
				className="container w-full h-full relative flex flex-col justify-center items-center overflow-hidden"
			...
			<div className="container p-0 w-6/12  h-full bg-gray-200">
				<RSwiper />
			</div>
		</section>
	);
